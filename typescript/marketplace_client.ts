...
async function auction() {
    ...
    await tokenClient.createCollection(seller, collection_name, "meena's simple collection", "https://aptos.dev");
    await tokenClient.createToken(seller, collection_name, token_name, "meena's simple token", 1, "https://aptos.dev/img/nyan.jpeg");
